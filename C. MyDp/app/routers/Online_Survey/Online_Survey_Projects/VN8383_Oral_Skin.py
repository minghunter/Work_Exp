...
class VN8383OralSkin(APDataConverter, DataTableGenerator, ConvertUnstack, LSMCalculation):

    def convert_vn8383_oral_skin(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8383_oral_skin(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8383_oral_skin(self, tables_format_file, codelist_file, coding_file):
        """
