...
class VN8347PSPromotion(APDataConverter, DataTableGenerator, ConvertUnstack, LSMCalculation):

    def convert_vn8347_ps_promotion(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8347_ps_promotion(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8347_ps_promotion(self, tables_format_file, codelist_file, coding_file):
        """
