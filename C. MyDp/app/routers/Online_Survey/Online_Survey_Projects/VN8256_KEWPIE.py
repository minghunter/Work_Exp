...
class VN8256Kewpie(APDataConverter, DataTableGenerator, ConvertUnstack):

    def convert_vn8256_kewpie(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8256_kewpie(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8256_kewpie(self, tables_format_file, codelist_file, coding_file):
        """
        ...
        df_data.loc[(~df_data['Main_Q3'].isin([2, 3])), ['Main_Q5_2']] = [np.nan]
