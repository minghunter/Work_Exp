...
class VN8420TetStoryboard(APDataConverter, DataTableGenerator, ConvertUnstack, LSMCalculation, ConvertStack):

    def convert_vn8420_tet_storyboard(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8420_tet_storyboard(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8420_tet_storyboard(self, tables_format_file, codelist_file, coding_file):
        """
