...
class VN8332Tokyo3(APDataConverter, DataTableGenerator, ConvertUnstack):

    def convert_vn8332_tokyo_3(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8332_tokyo_3(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8332_tokyo_3(self, tables_format_file, codelist_file, coding_file):
        """
        ...
        df_data_output['SCR2'] = df_data_output['SCR2'].astype(int)
        df_info_output.loc[df_info_output['var_name'] == 'SCR2', ['var_type']] = ['NUM']
