...
class VN8263Lapental(APDataConverter, DataTableGenerator, ConvertUnstack):

    def convert_vn8263_lapental(self, py_script_file, tables_format_file, codelist_file, coding_file):
