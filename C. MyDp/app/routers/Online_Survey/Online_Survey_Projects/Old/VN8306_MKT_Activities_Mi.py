...
class VN8306MKTActivitiesMi(APDataConverter, DataTableGenerator, ConvertUnstack):

    def convert_vn8306_mkt_activities_mi(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8306_mkt_activities_mi(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8306_mkt_activities_mi(self, tables_format_file, codelist_file, coding_file):
        """
