...
class VN8319TvcMixTestIntercept(APDataConverter, DataTableGenerator, ConvertUnstack):

    def convert_vn8319_tvc_mix_test_intercept(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8319_tvc_mix_test_intercept(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8319_tvc_mix_test_intercept(self, tables_format_file, codelist_file, coding_file):
        """
        ...
        df_data_output['Recruit_S3_Nam_sinh'] = df_data_output['Recruit_S3_Nam_sinh'].astype(int)
        df_info_output.loc[df_info_output['var_name'] == 'Recruit_S3_Nam_sinh', ['var_type']] = ['NUM']
