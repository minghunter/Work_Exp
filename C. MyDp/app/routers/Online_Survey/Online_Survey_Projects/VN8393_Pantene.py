...
class VN8393Pantene(APDataConverter, DataTableGenerator, ConvertUnstack, LSMCalculation, ConvertStack):

    def convert_vn8393_pantene(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8393_pantene(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8393_pantene(self, tables_format_file, codelist_file, coding_file):
        """
        ...
        dict_qre_group_mean = {
            'PurchaseFactor': {
                'range': [f'0{i}' for i in range(1, 9)],
