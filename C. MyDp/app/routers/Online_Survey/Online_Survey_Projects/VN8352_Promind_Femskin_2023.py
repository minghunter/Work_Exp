...
class VN8352PromindFemskin2023(APDataConverter, DataTableGenerator, ConvertUnstack, LSMCalculation, ConvertStack):

    def convert_vn8352_promind_femskin_2023(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8352_promind_femskin_2023(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8352_promind_femskin_2023(self, tables_format_file, codelist_file, coding_file):
        """
        ...
        df_info.loc[df_info['var_name'].str.contains("CU1c_|CU1d_"), ['var_type']] = ['NUM']
