...
class VN8053PromindMosquito2022(APDataConverter, DataTableGenerator, ConvertUnstack):

    def convert_vn8053_promind_mosquito_2022(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8053_promind_mosquito_2022(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8053_promind_mosquito_2022(self, tables_format_file, codelist_file, coding_file):
        """
