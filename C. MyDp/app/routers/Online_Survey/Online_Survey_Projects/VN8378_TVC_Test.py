...
from app.routers.Online_Survey.convert_stack import ConvertStack
import pandas as pd
import numpy as np
import time
import traceback
...
class VN8378TVCTest(APDataConverter, DataTableGenerator, ConvertUnstack, ConvertStack):

    def convert_vn8378_tvc_test(self, py_script_file, tables_format_file, codelist_file, coding_file):
        ...
        try:
            ...
            self.processing_script_vn8378_tvc_test(tables_format_file, codelist_file, coding_file)
    ...
    def processing_script_vn8378_tvc_test(self, tables_format_file, codelist_file, coding_file):
        """
        ...
        if dict_qre_OE_info:
            ...
            df_fil = df_data_output.query(f"Q14_o3_OE_1.isnull()").copy()
            df_data_output.loc[df_fil.index,  ['Q14_o3_OE_1']] = [999]

            df_fil = df_data_output.query(f"Q16_o1_OE_1.isnull()").copy()
            df_data_output.loc[df_fil.index, ['Q16_o1_OE_1']] = [999]

            df_fil = df_data_output.query(f"Q20b_o2_OE_1.isnull()").copy()
            df_data_output.loc[df_fil.index, ['Q20b_o2_OE_1']] = [999]
        ...
        df_info_output = self.remove_net_code(df_info_output)
